 <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part"><a class="logo" href="index-2.html"><b>
                  <img src="images/eliteadmin-logo.png" alt="home" class="dark-logo" />

                  <img src="images/eliteadmin-logo-dark.png" alt="home" class="light-logo" /></b>
                  <span class="hidden-xs">
                    <img src="images/eliteadmin-text.png" alt="home" class="dark-logo" />
                    <img src="images/eliteadmin-text-dark.png" alt="home" class="light-logo" /></span></a>
                </div>
